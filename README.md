...
*Кастомный дашборд Grafana: загрузка CPU, памяти, сети и топ процессов контейнеров.*
...
- ✅ **Интеграция с Gmail (IMAP/SMTP) и Exchange (EWS)** для почты, контактов и календарей.
