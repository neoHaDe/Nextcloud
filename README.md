...
Полностью автономная инфраструктура для личного облака, развернутая на **Windows 11** с использованием **Docker и Docker Compose**.  
...
| ⚙️ CI/CD         | Развертывание и управление жизненным циклом контейнеров на основе Docker Compose             |
